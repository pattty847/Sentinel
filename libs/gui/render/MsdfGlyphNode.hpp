...
Role: Renders MSDF glyph quads with a shared atlas texture.
...
class MsdfGlyphMaterial final : public QSGMaterial {
public:
    MsdfGlyphMaterial();
...
class MsdfGlyphNode final : public QSGGeometryNode {
public:
    struct GlyphQuad {
        QVector2D pos[6];
        QVector2D uv[6];
